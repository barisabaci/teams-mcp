...
export const READ_TOOL_ENDPOINTS: readonly EndpointSpec[] = [
	...
	{ method: "GET", path: "/chats/{chatId}/messages/{messageId}/hostedContents/{hostedContentId}/$value", tool: "download_chat_hosted_content" },

	{ method: "GET", path: "/me/joinedTeams", tool: "list_teams" },
	{ method: "GET", path: "/teams/{teamId}/channels", tool: "list_channels" },
	{ method: "GET", path: "/teams/{teamId}/channels/{channelId}/messages", tool: "get_channel_messages" },
	{ method: "GET", path: "/teams/{teamId}/channels/{channelId}/messages/{messageId}/replies", tool: "get_channel_message_replies" },
	...
	{ method: "GET", path: "/users?$filter=...", tool: "search_users_for_mentions", notes: "uses $search/$filter; handler will return fixture subset" },

	{ method: "GET", path: "/teams/{teamId}/channels/{channelId}/messages/{messageId}/hostedContents/{hostedContentId}/$value", tool: "download_message_hosted_content" },
] as const;
